  ...
  data() {
    return {
      ...
      configForm: {
        ...
        is_active: true,
        semester_rate_returning: 55,
        semester_rate_new: 110,
  ...
  methods: {
    ...
    loadConfig(config) {
      ...
      this.configForm = {
        ...
        semester_rate_returning: config.semester_rate_returning || 55,
        semester_rate_new: config.semester_rate_new || 110,
    ...
    async handleSave() {
      try {
        ...
        const submitData = {
          ...
          semester_rate_returning: parseFloat(this.configForm.semester_rate_returning) || 0,
          semester_rate_new: parseFloat(this.configForm.semester_rate_new) || 0,
